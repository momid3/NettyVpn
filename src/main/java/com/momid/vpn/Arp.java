...
import static com.momid.vpn.TunVpnServerCKt.SERVER_IP;
...
public class Arp {
    ...
    private static final MacAddress SRC_MAC_ADDR = MacAddress.getByName("00:16:3e:97:2b:f6");

    private static MacAddress resolvedAddr;

    private Arp() {}

    public static void arpRequest(MacAddress sourceMacAddress, String gatewayIpAddress, ArpResult result) throws PcapNativeException, NotOpenException {
        String strSrcIpAddress = SERVER_IP; // for InetAddress.getByName()
